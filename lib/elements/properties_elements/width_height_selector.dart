...
class WidthSelector extends StatelessWidget {
  ...
  const WidthSelector(
      {Key key, this.onChanged, this.lable, this.initialValue = 1.0})
      : super(key: key);
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ChangeNotifierProvider<SliderController>(
            create: (context) => SliderController(onChanged, initialValue),
            child:
                Consumer<SliderController>(builder: (context, controller, _) {
              return NeumorphicSlider(
                value: controller.value,
                style:
                    SliderStyle(accent: green, variant: green.withAlpha(100)),
                min: 0,
                max: 1.0,
